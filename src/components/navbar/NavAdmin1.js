        ...
        return(
           ...
           { /*<div >
            ...
            <Navbar.Collapse id="basic-navbar-nav " className="buttton-nav">
                ...
                <Button href="/home" variant="nav" ><p style={{textAlign:"center",marginBottom:"0.1rem"}}>INICIO</p></Button>
                <Button href="/resumendeobra" variant="nav" > <p style={{textAlign:"center",marginBottom:"0.1rem"}}>RESUMEN DE OBRA</p> </Button>
                <Button href="/eias" variant="nav" ><p style={{textAlign:"center",marginBottom:"0.1rem"}}>ESTUDIO DE IMPACTO AMBIENTAL Y SOCIAL</p></Button>
                <Button href="/informe" variant="nav" ><p style={{textAlign:"center",marginBottom:"0.1rem"}}>INFORME DE LA CONSULTA PUBLICA AÑO 2017 </p></Button>
                <Button href="/habilitaciones" variant="nav" ><p style={{textAlign:"center",marginBottom:"0.1rem"}}>HABILITACIONES Y PERMISOS</p> </Button>
                <Button href="/faq" variant="nav" ><p style={{textAlign:"center",marginBottom:"0.1rem"}}>PREG. FRECUENTES y CONSULTAS</p> </Button>
                </Nav>
